...
Execution model for a cash-style Interactive Brokers account where stock sale
...
When a portfolio policy calls for selling the current position and buying a new
selected ticker:
