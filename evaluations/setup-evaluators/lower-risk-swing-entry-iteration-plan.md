...
| Evaluation cadence | `weekly`, `monthly` | Tests whether signals need frequent refresh or survive slower review cadence. |
...
- Limit-entry trigger rate is high enough that the trade plan is reachable.
