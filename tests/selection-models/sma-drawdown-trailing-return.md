...
Verify that the selection model applies eligibility, ranking, target-count, and
...
| No eligible tickers | No ticker passes eligibility | Return fallback ticker supplied by universe profile. |
